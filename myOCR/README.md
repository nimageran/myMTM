...
**READ THIS FIRST:** This tool is designed for **maximum privacy**.
...
* **No Installation Required:** Runs directly in Chrome, Edge, or Firefox.
* **Offline Capable:** Works even if you disconnect your internet after loading the page.
* **Multi-Page Support:** Automatically handles PDF files with multiple pages.
* **Visual Themes:** Includes a "Corporate Light" mode for office environments and high-contrast dark modes.

---

### Technical Note for Auditors
This application utilizes `Tesseract.js` and `PDF.js` via CDNs. It operates entirely on the client-side (frontend) with **no backend server** storage or processing.
